...
class CoWorkers extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
      ...
      <>
        ...
        <View style={{ marginTop: 13 }}>
          <Text style={styles.heading}>
            {this.props.People.totalWorkers}{" "}
            {this.props.People.totalWorkers > 1 ? "Co-Workers" : "Co-Worker"}
          </Text>
        </View>
      </>
    );
        ...
        <View style={styles.container}>
          <View style={styles.scrolledview}>
            <FlatList
              ...
              data={this.props.People.workers}
...
export default connect(mapStateToProps, undefined, mergeProps)(CoWorkers);