...
class FriendsCustomers extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
      ...
      <>
        ...
        <View style={{ marginTop: 13 }}>
          <Text style={styles.heading}>
            {this.props.People.totalCustomers}{" "}
            {this.props.People.totalCustomers > 1 ? "Customers" : "Customer"}
          </Text>
        </View>
      </>
    );
        ...
        <View style={styles.container}>
          <View style={styles.scrolledview}>
            <FlatList
              ...
              data={this.props.People.customers}
...
export default connect(mapStateToProps, undefined, mergeProps)(FriendsCustomers);
