...
class InvitedContacts extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
  ...
  invitesToSelectedContact = async () => {
    ...
    const json = await LifeWidget.shareMessage({
      data: selected,
      message: message,
    });
          ...
          <View style={styles.pendinginvitesnamecontainer}>
            ...
            {!item.user && (
              <View style={styles.multibtns}>
                ...
                >
                  <Text style={styles.graybtntext}>Re-invite</Text>
                </TouchableOpacity>
              </View>
            )}
          </View>
        ...
        >
          ...
          {selected.length > 1 && (
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              >
                <Text style={{ color: Color.primary }}>{"Unselect all"}</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
        ...
        <Portal>
          <Modalize ref={this.modalizeRef} adjustToContentHeight={true}>
            <View style={styles.topWidget}>
              ...
              />
              <Text
                style={{ alignSelf: "flex-end", color: Color.gray, margin: 5 }}
              >
                {message.length}
              </Text>
...
export default connect(mapStateToProps, undefined, mergeProps)(InvitedContacts);
