...
class EventsInterested extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  _onRefresh = () => {
    ...
    let params = {};
    params["interested"] = 1;
    this.props.fetchEvent(this.per_page, this.page, params, "interested");
  };
  ...
  componentDidMount() {
    let params = {};
    params["interested"] = 1;
    this.props.fetchEvent(10, 1, params, "interested");
  }
  ...
  renderEvent = () => {
    const { interestedEventData } = this.props;
    console.log("gData......", interestedEventData);
    return (
      <FlatList
        ref={(ref) => {
  ...
  render() {
    const { interestedEventData, responseData } = this.props;
    return (
...
const mapStateToProps = (state) => {
  return {
    ...
    interestedEventData:
      typeof state.Event.interestedEventData !== "undefined"
        ? state.Event.interestedEventData
        : {},
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(EventsInterested);
