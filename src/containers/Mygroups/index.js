...
class Mygroups extends React.Component {
  ...
  componentDidMount() {
    this.props.navigation.setOptions({
      headerTitle: () => <View style={styles.headertitle}><Text style={styles.headertitleText}>Groups you managed</Text></View>
    });
  ...
  onEndReached = ({ distanceFromEnd }) => {
    if (!this.props.isOwnerFetching) {
      if (this.props.totalOwner > this.props.owners.length) {
        this.page++;
        this.props.fetchGroupsOwner(this.per_page, this.page, {type:"me"});
      }
    }
  ...
  render() {
    const { owners, isOwnerFetching } = this.props;
    return (
...
const mapStateToProps = (state) => {
  return {
    ...
    isOwnerFetching: state.Group.isOwnerFetching,
    totalOwner: state.Group.totalOwner,
  };
};
...
export default connect(mapStateToProps, undefined, mergeProps)(Mygroups);