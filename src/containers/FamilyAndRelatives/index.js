...
class FamilyAndRelatives extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
      ...
      <>
        <View style={[styles.roundedtextinputcontainer, styles.boxShadow]}>
          ...
          <TextInput
            ...
            placeholder="Search Family & Relatives"
        ...
        <View style={{ marginTop: 13 }}>
          <Text style={styles.heading}>
            {this.props.People.totalFamilies}{" "}
            {this.props.People.totalFamilies > 1 ? "Family" : "Family"}
          </Text>
        </View>
      </>
    );
        ...
        <View style={styles.container}>
          <View style={styles.scrolledview}>
            <FlatList
              ...
              data={this.props.People.families}
