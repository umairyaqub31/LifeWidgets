...
class BusinessAssociate extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
      ...
      <>
        <View style={[styles.roundedtextinputcontainer, styles.boxShadow]}>
          ...
          <TextInput
            ...
            placeholder="Search Business Associate"
        ...
        <View style={{ marginTop: 13 }}>
          <Text style={styles.heading}>
            {this.props.People.totalBusinesses}{" "}
            {this.props.People.totalBusinesses > 1
              ? "Business Associates"
              : "Business Associate"}
          </Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.scrolledview}>
            <FlatList
              ...
              data={this.props.People.businesses}
