...
class ChatService {
  ...
  async sendMessageAsAttachment(dialog, recipient_id, msg, attachments) {
    ...
    console.log(response,'uploadImageonicloud');
  ...
  async getMessages(dialog) {
   ...
   // console.log(amountMessages,'ffffffffffffffffff');
    ...
    console.log(amountMessages,'kjjkjkjkjkjkjkjk');
    return amountMessages
  }

  // Message loading if more than 100
  getMoreMessages = async (dialog) => {
    console.log(dialog,'moreeeeeeeeeeeeeeeeeeeeeeeeeeee')
