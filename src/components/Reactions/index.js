...
export default class Reactions extends Component {
  constructor(props) {
    ...
    // Duration animation
    this.durationAnimationBox = 10;
    this.durationAnimationQuickTouch = 10;
    this.durationAnimationLongTouch = 5;
    this.durationAnimationIconWhenDrag = 5;
    this.durationAnimationIconWhenRelease = 10;
    ...
    return (
      <>
        {/* Body */}
          ...
          {/* Content */}
          <View style={styles.viewContent} {...this.rootPanResponder.panHandlers}>
            {/* Box */}
            {/* <Animated.View
              style={[
                styles.viewBox,
