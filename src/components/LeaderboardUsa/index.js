...
class LeaderboardUsa extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
...
const mapStateToProps = (state) => {
  return {
    ...
    typeof state.People.leaderboards !== "undefined"
      ? typeof state.People.leaderboards["US"] !== "undefined"
        ? state.People.leaderboards["US"]
        : []
      : [],
...
const mergeProps = (stateProps, dispatchProps, ownProps) => {
  ...
  return {
    ...
    ...stateProps,
    leaderboards: () => {
      actions.fetchLeaderboards(dispatch, {code:"US"});
    },
...
export default connect(mapStateToProps, undefined, mergeProps)(LeaderboardUsa);
