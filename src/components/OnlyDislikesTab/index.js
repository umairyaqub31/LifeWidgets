...
class OnlyDislikesTab extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  fetchData = async () => {
    ...
    const data = await LifeWidget.getDislikeUsers(
      this.per_page,
      this.page,
      this.params
    );
              ...
              <TouchableOpacity style={styles.profileimagewithoption}>
                <View style={styles.profileimage}>
                  <View style={styles.avataroverly}>
                    ...
                    <View style={[styles.avataroverlyicon, styles.dislike]}>
                    <AntDesign name="dislike1" size={14} color={colors.white} />
                    </View>
                  </View>
                  <View>
...
export default OnlyDislikesTab;
